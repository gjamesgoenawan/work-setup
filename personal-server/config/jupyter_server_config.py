...
#  Default: ''
c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$4KMDRAmjdurAhRdUMjUJew$8TtuUIycK8ByGEVmskjmJajXjydhSI86iL3485xaApc'
...
#  Choices: any of ['sha3_384', 'md5', 'sha1', 'sha3_224', 'blake2b', 'sha256', 'sha384', 'blake2s', 'sha224', 'sha3_256', 'sha512', 'sha3_512']
#  Default: 'sha256'
